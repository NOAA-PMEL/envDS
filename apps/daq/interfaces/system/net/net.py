...
class NetInterface(Interface):
    ...
    metadata = {
        "attributes": {
            ...
            "name": {"type": "char", "data": "net"},
            "description": {
                "type": "char",
                "data": "Network based interfaces (e.g., tcp, udp)",
            },
            "tags": {"type": "char", "data": "network, tcp, udp"},
        },
        "paths": {
            # "udp-10080": { # example
            #     "attributes": {
            ...
            #         "remote-host": {"type": "string", "data": "127.0.0.1"},
            #         "remote-port": {"type": "int", "data": 10080},
            #         "local-host": {"type": "string", "data": "0.0.0.0"},
            #         "local-port": {"type": "int", "data": 10080},
            #     },
            #     # "type": "could add type here in case different types of client"
            #     "data": []
            # },
            # "tcp-127.0.0.1:10081": { # example
            #     "attributes": {
            ...
            #         "host": {"type": "string", "data": "127.0.0.1"},
            #         "port": {"type": "int", "data": 10081},
            #     },
            #     # "type": "could add type here in case different types of client"
            #     "data": []
            # },
    ...
    def __init__(self, config=None, **kwargs):
        # print("mock:1")
        super(NetInterface, self).__init__(config=config, **kwargs)
        # print("mock:2")
        self.data_task = None
        self.data_rate = 1
        # self.configure()
    ...
    def configure(self):
        ...
        # print("configure:1")
        super(NetInterface, self).configure()
        ...
        try:
            ...
            atts = NetInterface.metadata["attributes"]

            # print("configure:7")
            path_map = dict()
            # for name, val in NetInterface.metadata["paths"].items():
            if "paths" in conf:
